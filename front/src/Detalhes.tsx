          ...
          <section className="flex flex-col md:flex-row gap-12 mb-24 relative">
              ...
              <div className="w-full md:w-2/3 lg:w-3/4 flex flex-col justify-center">
                  ...
                  <div className="flex flex-wrap gap-4 mb-10">
                      ...
                      <button className="bg-surface-container/50 backdrop-blur-md border border-white/20 hover:border-white/50 text-on-surface px-8 py-4 rounded-lg font-headline-md text-headline-md flex items-center gap-3 transition-all duration-300 hover:scale-105 hover:bg-surface-container">
