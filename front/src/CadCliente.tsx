    ...
    return (
        ...
        <div className="flex flex-col w-full min-h-[calc(100vh-5rem)] justify-center items-center px-margin-mobile md:px-margin-tablet py-margin-desktop relative overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 pb-3">
                ...
                <span className="font-caption text-caption px-2 py-0.5 rounded bg-surface-container-high text-secondary">NOVO SÓCIO</span>
            </div>
            ...
            <div className="bg-surface-container-low rounded-xl shadow-2xl p-8 md:p-10 flex flex-col relative overflow-hidden backdrop-blur-md">
                ...
                <div className="flex flex-col gap-2 text-left">
                    <label className="font-label-md text-caption uppercase text-on-surface tracking-wider">Senha</label>
                    <div className="relative flex items-center">
                ...
                <div className="flex flex-col gap-2 text-left">
                    <label className="font-label-md text-caption uppercase text-on-surface tracking-wider" >Confirmar Senha</label>
                    <div className="relative flex items-center">
